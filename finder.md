---
name: finder
description: "Fast, parallel code search agent. Use to locate files and line ranges relevant to a query — call sites, usages, implementations, where a feature lives. Returns a concise summary plus a markdown-linked list of relevant files with line ranges. Optimized for breadth-first search with high parallelism; not for exploration-style essays."
